...
var COW *SoundCollection = &SoundCollection{
	...
	Sounds: []*Sound{
		createSound("herd", 1, 250),
		createSound("moo", 1, 250),
...
var WAM *SoundCollection = &SoundCollection{
	Prefix: "wam",
	Commands: []string{
		"!wam",
		"!dedotaded",
	...
	Sounds: []*Sound{
		createSound("crash", 1, 250),
		createSound("dedotaded", 1, 250),
	},
}
